...
const AccountInfo = () => {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-md max-w-lg mx-auto border border-[#D4AF37]">
      ...
      <p className="text-gray-700"><strong>Account Name:</strong> Mujjahiduun Central Mosque,Pegamut</p>
      <p className="text-gray-700"><strong>Bank Name:</strong> FCMB Bank</p>
      <p className="text-gray-700"><strong>Account Number:</strong> 5662815017</p>
